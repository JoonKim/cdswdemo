...
conn = connect(host='10.0.123.152', port=21050)
#   172.28.210.3
cursor = conn.cursor()
cursor.execute('SELECT * FROM sample_07 LIMIT 5') 

print (cursor.description)  # prints the result set's schema
results = cursor.fetchall()
print (results)
cursor.execute('select salary, total_emp from sample_07 where total_emp < 400000 limit 500')
